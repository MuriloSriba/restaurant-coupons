...
-- Restaurants table with approval status
CREATE TABLE IF NOT EXISTS users {
    id SERIAL PRIMARY KEY,
    first_name VARCHAR(100),
    last_name VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS users {
    ...
    password_hash VARCHAR(255) NOT NULL,
    role VARCHAR(50) DEFAULT 'user',
    created_at TIMESTAMPVou continuar com a atualização das rotas do backend para implementar a lógica de aprovação e listagem de restaurantes.

<create_file>
<path>backend/routes/restaurants-updated.js</path>
<content>
